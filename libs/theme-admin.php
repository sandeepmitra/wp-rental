...
function new_wpestate_main_menu_design(){
    ...
    <div class="option_row_explain">'.__('Transparent Heder - Top Menu Font Color','wpestate').'</div>    
    ...
    print'<div class="estate_option_row">
    <div class="label_option_row">'.__('Transparent Heder - Top Menu Hover Font Color','wpestate').'</div>
    <div class="option_row_explain">'.__('Transparent Heder - Top Menu Hover Font Color','wpestate').'</div>    
