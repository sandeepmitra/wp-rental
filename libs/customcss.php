...
print 'h1, h2, h3, h4, h5, h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a ,.featured_property h2 a, .featured_property h2,'
    . '.blog_unit h3, .blog_unit h3 a,.submit_container_header {color: #'.$headings_color.';}';
} // end $headings_color 
...
if ($adv_search_font_color != '') {
    print '.advanced_search_shortcode .caret_filter,.advanced_search_shortcode .form-control,
    .advanced_search_shortcode input[type=text],.advanced_search_shortcode .form-control::-webkit-input-placeholder,
    .adv-search-1 .caret_filter,.adv-search-1 .form-control,.adv-search-1 input[type=text],
    .adv-search-1 .form-control::-webkit-input-placeholder{color:#'.$adv_search_font_color.';}';
} 
