...
';
        ...
        if($prop_unit_min_height!=''){
            $style.='.property_listing,#google_map_prop_list_sidebar .property_listing{
        ...
        if ($main_grid_content_width!='' && $main_grid_content_width!='1200'){
            ...
            .adv-search-1{
                ...
                margin-left: '.(-1*$main_grid_content_width/2+45).'px;
            }
            .transparent-wrapper{  
                width:'.($main_grid_content_width-90).'px;
            }
            ...
            #advanced_submit_22{
                width:'. ( ($main_grid_content_width-13-274)/4-17).'px;
            }
            
         
            .search_wr_2 .adv-search-1 input[type=text],
            .search_wr_2 .adv-search-1 .form-control,
            #advanced_submit_22{
                width:'. ( ($main_grid_content_width-90-52-39-8)/5).'px;
            }
            
            .adv-search-1 .filter_menu,
            .adv-search-1 .filter_menu li{
                width:'. ( ($main_grid_content_width-13-274)/4-17).'px;
                min-width:'. ( ($main_grid_content_width-13-274)/4-17).'px;
                overflow-x: hidden;
            }
            ...
            .search_wr_2 .adv-search-1 .filter_menu,
            .search_wr_2 .adv-search-1 .filter_menu li{
                min-width:'.( ( ($main_grid_content_width-90-52-39-8)/5) ) .'px;
                width:'.( ( ($main_grid_content_width-90-52-39-8)/5) ).'px;
            }
            ...
            #adv_location{
                width:'.( ( ($main_grid_content_width-90-52-39-8)/5)*2).'px;
            }
...
function wpestate_build_unit_custom_structure($custom_unit_structure,$propID,$property_unit_slider){
    ...
    foreach($custom_unit_structure as $rows){
        ...
        foreach($rows as $columns){
           print '<div class="property_unit_custom col-md-'.$col_md.'  ">';
                foreach($columns as $elements){
